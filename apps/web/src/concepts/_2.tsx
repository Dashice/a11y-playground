      ...
      <div className="max-w-2xl flex flex-col gap-4">
        <section className={section}>
          <ol className={list}>
            ...
            <li className={tw(box, white, 'bg-orange-100')}>Aa</li>
            <li className={tw(box, white, 'bg-orange-300')}>Aa</li>
            <li className={tw(box, white, 'bg-orange-500')}>Aa</li>
            <li className={tw(box, white, 'bg-orange-700')}>Aa</li>
            <li className={tw(box, white, 'bg-orange-900')}>Aa</li>
          </ol>
          <ol className={list}>
            <li className={tw(box, white, 'bg-yellow-100')}>Aa</li>
            <li className={tw(box, white, 'bg-yellow-300')}>Aa</li>
            <li className={tw(box, white, 'bg-yellow-500')}>Aa</li>
            <li className={tw(box, white, 'bg-yellow-700')}>Aa</li>
            <li className={tw(box, white, 'bg-yellow-900')}>Aa</li>
          </ol>
          <ol className={list}>
            <li className={tw(box, white, 'bg-lime-100')}>Aa</li>
            <li className={tw(box, white, 'bg-lime-300')}>Aa</li>
            <li className={tw(box, white, 'bg-lime-500')}>Aa</li>
            <li className={tw(box, white, 'bg-lime-700')}>Aa</li>
            <li className={tw(box, white, 'bg-lime-900')}>Aa</li>
          </ol>
          <ol className={list}>
            <li className={tw(box, white, 'bg-cyan-100')}>Aa</li>
            <li className={tw(box, white, 'bg-cyan-300')}>Aa</li>
            <li className={tw(box, white, 'bg-cyan-500')}>Aa</li>
            <li className={tw(box, white, 'bg-cyan-700')}>Aa</li>
            <li className={tw(box, white, 'bg-cyan-900')}>Aa</li>
          </ol>
          <ol className={list}>
            <li className={tw(box, white, 'bg-blue-100')}>Aa</li>
            <li className={tw(box, white, 'bg-blue-300')}>Aa</li>
            <li className={tw(box, white, 'bg-blue-500')}>Aa</li>
            <li className={tw(box, white, 'bg-blue-700')}>Aa</li>
