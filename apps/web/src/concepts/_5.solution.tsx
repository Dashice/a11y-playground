        ...
        >
          ...
          <div className="border-b border-slate-600 flex items-center gap-2 justify-between px-2 py-1">
            <div className="flex items-center gap-2">
              <img src="/icons/layout.svg" className="rtl:scale-x-[-1]" />
              <img src="/icons/arrow-left.svg" className="rtl:scale-x-[-1]" />
              <img src="/icons/arrow-right.svg" className="rtl:scale-x-[-1]" />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <img src="/icons/share.svg" className="rtl:scale-x-[-1]" />
              <img
          ...
          <div className="py-4 px-2 relative">
            <button
              type="button"
              className="rounded-full bg-slate-700 p-0.5 custom absolute end-4 top-4"
              aria-label="Close"
            >
            ...
            <p className="text-slate-400 text-xs mb-4">{getParagraph(isRTL)}</p>
            <p dir="ltr" className="text-slate-400 text-xs mb-4">
          ...
          <div className="border-t border-slate-600 flex items-center gap-2 justify-between px-2 py-1">
            <div className="flex items-center gap-2">
              <img src="/icons/file-text.svg" className="rtl:scale-x-[-1]" />
              <img src="/icons/edit.svg" />
              <img src="/icons/list.svg" className="rtl:scale-x-[-1]" />
            </div>
            <div className="flex items-center gap-2">
              <img
            ...
            <div className="flex items-center gap-2">
              ...
              <img src="/icons/rss.svg" className="rtl:scale-x-[-1]" />
